...
question1.innerHTML = `
    <h1 id="q-1-h1">What is the correct plural form of the word "child"?</h1>
    <button id="q-1-1" class="q-1-but">Childs</button>
    <button id="q-1-2" class="q-1-but">Children</button>
    <button id="q-1-3" class="q-1-but">Childrens</button>
    <button id="q-1-4" class="q-1-but">Child</button><br>
...
nextButton1.addEventListener("click", () => {
    if (correctAnswerSelected1) {
        ...
        question2.innerHTML = `
            <h1 id="q-2-h1">What is the synonym of the word "happy"?</h1>
            <button id="q-2-1" class="q-2-but">Sad</button>
            <button id="q-2-2" class="q-2-but">Lonely</button>
            <button id="q-2-3" class="q-2-but">Angry</button>
            <button id="q-2-4" class="q-2-but">Joyful</button><br>
        ...
        nextButton2.addEventListener("click", () => {
            if (correctAnswerSelected2) {
                ...
                question3.innerHTML = `
                    <h1 id="q-3-h1">Which word is a noun?<h1>
                    <button id="q-3-1" class="q-3-but">Run</button>
                    <button id="q-3-2" class="q-3-but">Cool</button>
                    <button id="q-3-3" class="q-3-but">Rain</button>
                    <button id="q-3-4" class="q-3-but">Chair</button><br>
